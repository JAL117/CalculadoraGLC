...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression','parser_logic.py',34),
  ('expression -> expression MINUS term','expression',3,'p_expression','parser_logic.py',35),
  ('expression -> term','expression',1,'p_expression_term','parser_logic.py',39),
  ('term -> term TIMES factor','term',3,'p_term','parser_logic.py',43),
  ('term -> term DIVIDE factor','term',3,'p_term','parser_logic.py',44),
  ('term -> factor','term',1,'p_term_factor','parser_logic.py',48),
  ('factor -> NUMBER','factor',1,'p_factor_num','parser_logic.py',52),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','parser_logic.py',56),
]
